...
while (true) {
    ...
    if (ShowMenu) {
        ...
        if (tab == 2) {  // Vehicle/Transport tab
            ...
            if (ImGui.Checkbox("Always Stay On Bike", stayOnBike)) {
              stayOnBike = true;
              if (stayOnBike) {
                  if (onceBike) {
                      showTextBox("Always Stay On Bike on");
                      onceBike = false;
                  }
              }              
              ...
              if (!stayOnBike) {
                  if (onceBike) {
                      showTextBox("Always Stay On Bike off");
                      onceBike = false;
                  } 
              }
              onceBike = true;
        ...
        if (tab == 3) {  // Credits tab
          ...
          ImGui.NewLine();
          ImGui.Text("- seifmagdi for his continuous support");
          ImGui.Text("- Grinch and Seemann for making ImGuiRedux")
          ImGui.Text("- PurpleWolfy/NightWolfy004 for inspiration")
        }
